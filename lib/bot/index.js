...
class TadaBot {
  ...
  addCommandOptions(client) {
    ...
    client.registry.registerGroup("tada-user", "Tada Commands");
    client.registry.registerGroup("tada-guild-admin", "Tada Admin Commands");
    client.registry.registerGroup("tada-owner", "Tada SysAdmin Commands");
