...
async function handleIntroPlayback({ member, intro, channel, db, config }) {
  let dispatcher;

  let soundFile = await member.client.soundManager.getSoundFileOfChecksum({ checksum: intro });
